...
local M = {
  ...
  },
  {
    ...
    cmd = { 'DirDiff' },
    init = function()
      require('bsaada.user.menu').add_actions('Diff', {
        ['Between 2 directories'] = function()
          local pretty_print = require('bsaada.user.utils').pretty_print
  ...
  },
  {
    ...
    ft = 'markdown',
    init = function()
      require('bsaada.user.menu').add_actions('Markdown', {
  ...
  },
  {
    ...
    init = function()
      require('bsaada.user.menu').add_actions('Yanky', {
