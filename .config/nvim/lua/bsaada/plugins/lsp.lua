...
M.init = function()
  ...
  require('bsaada.user.menu').add_actions('LSP', {
...
M.config = require('bsaada.user.lsp.config').setup
...
local language_specific_plugins = {
  { 'cuducos/yaml.nvim', ft = 'yaml' },
  {
    ...
    config = function()
      ...
      require('bsaada.user.menu').add_actions('JSON', {
  ...
  },
  {
    ...
    config = function()
      ...
      require('bsaada.user.menu').add_actions('YAML', {
