...
local utils = require 'bsaada.user.utils'
...
local fugitive_config = function()
  ...
  require('bsaada.user.menu').add_actions('Git', vim.tbl_extend('force', actions(), diff_actions))
  vim.keymap.set('n', '<leader>gm', function()
    local git_actions = require('bsaada.user.menu').get_actions { prefix = 'Git' }
...
local M = {
  ...
  },
  {
    ...
    config = function()
      ...
      require('bsaada.user.menu').add_actions('GitConflict', {
