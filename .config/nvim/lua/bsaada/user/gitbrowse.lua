---@class bsaada.user.gitbrowse
---@overload fun(opts?: bsaada.user.gitbrowse.Config)
...
---@class bsaada.user.gitbrowse.Config
---@field url_patterns? table<string, table<string, string|fun(fields:bsaada.user.gitbrowse.Fields):string>>
local defaults = {
...
---@class bsaada.user.gitbrowse.Fields
---@field branch? string
---@field file? string
...
---@private
---@param remote string
---@param opts? bsaada.user.gitbrowse.Config
...
---@param repo string
---@param fields bsaada.user.gitbrowse.Fields
---@param opts? bsaada.user.gitbrowse.Config
...
function M._open(opts)
  ...
  ---@type bsaada.user.gitbrowse.Fields
  local fields = {
